      ...
      <div className="grid gap-4 items-start" style={{gridTemplateColumns:'2fr 3fr'}}>
        ...
        <div className="flex-1 bg-white rounded-xl border border-gray-100 overflow-hidden">
          <div className="grid text-xs text-gray-400 font-medium px-3 py-2.5 bg-gray-50 border-b border-gray-100"
            style={{gridTemplateColumns:'70px 90px 90px 120px 100px 1fr 50px'}}>
            <div>Огноо</div>
            <div className="text-right">Тооцоолсон</div>
            <div className="text-right">Тушаасан</div>
            <div className="px-2">Эх үүсвэр</div>
                  ...
                  <div key={r.id}>
                    {!isEdit?(
                      <div className="grid items-center px-3 py-2.5 hover:bg-gray-50/50"
                        ...
                        <div className="text-xs text-gray-700 truncate px-2">{r.courier}</div>
