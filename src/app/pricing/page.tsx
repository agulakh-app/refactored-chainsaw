...
const PLANS = [
  { id:'demo',    label:'7 хоног',  days:7,   price:0,      display:'Үнэгүй',    desc:'Туршаад үзье' },
  { id:'month',   label:'1 сар',   days:30,  price:25000,  display:'25,000₮',   desc:'Сар бүр сунгая' },
  { id:'quarter', label:'3 сар',   days:90,  price:69900,  display:'69,900₮',   desc:'23,300₮/сар — 7% хямдрал', badge:'Боломжийн шүү' },
  { id:'year',    label:'1 жил',   days:365, price:255000, display:'255,000₮',  desc:'21,250₮/сар — 15% хямдрал', badge:'Илүү тогтвортой' },
]
